...
link = "http://suninjuly.github.io/find_xpath_form" # Создаем переменную для ссылки.
...
try:
    ...
    button = browser.find_element(By.XPATH, '/html/body/div[1]/form/div[6]/button[3]') # Находим поле для Кнопки
